...
class SkywarsGameEventListeners : Listener {
    ...
    fun onInventoryClickEvent(event: InventoryClickEvent) {
        val game = PotPvPRP.getInstance().gameHandler.getCurrentGame(event.whoClicked as Player)?: return
        val logic = game.logic as? SkywarsGameEventLogic ?: return
    ...
    fun onPrepareItemCraftEvent(event: PrepareItemCraftEvent) {
        val game = PotPvPRP.getInstance().gameHandler.getCurrentGame(event.viewers[0] as Player)?: return
        val logic = game.logic as? SkywarsGameEventLogic ?: return
